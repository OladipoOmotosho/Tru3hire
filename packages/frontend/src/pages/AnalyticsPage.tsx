...
import { TrendingUp, Target, Clock, DollarSign, Briefcase, Award } from "lucide-react";
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600 mb-1">Application Response Rate</p>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm font-bold text-green-600">45% success</span>
                </div>
              ...
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm font-bold text-blue-600">28% success</span>
                </div>
              ...
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm font-bold text-orange-600">12% success</span>
                </div>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                  <p className="font-medium text-gray-900">TrueHire Direct</p>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                  <p className="font-medium text-gray-900">Company Career Pages</p>
                ...
                {[
                  ...
                  <div key={item.skill}>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm text-gray-600">{item.demand}% of jobs</span>
                    </div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-600">San Francisco Bay Area</span>
                    <DollarSign className="w-4 h-4 text-green-600" />
                  </div>
                  <p className="text-2xl font-bold text-gray-900">$165k - $220k</p>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-gray-900">$155k - $210k</p>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-gray-900">$140k - $190k</p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Best Application Time:</strong> Your applications on Tuesday mornings
                    get 2.3x more responses than other times.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-1">•</span>
                  <span>
                    <strong>Optimal Application Volume:</strong> You're most successful when
                    applying to 3-5 jobs per week with TrueScore &gt; 75.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 mt-1">•</span>
                  <span>
                    <strong>Skill Gap Priority:</strong> Learning AWS could increase your average
                    TrueScore from 68 to 82 based on your saved jobs.
                  </span>
                </li>
              </ul>
            </div>
